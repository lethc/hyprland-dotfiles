# Generated by Powerlevel10k configuration wizard on 2023-03-10 at 09:17 -05.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    jiscalaenv                # scala version from scalaenv (https://github.com/scalaenv/scalaenv)
    haskell_stack           # haskell version from stack (https://haskellstack.org/)
    kubecontext             # current kubernetes context (https://kubernetes.io/)
    jterraform               # terraform workspace (https://www.terraform.io)
