...
# config.bind("zz", "zoom")
config.bind("<Ctrl-j>", "hint links spawn -d mpv --force-window yes {hint-url}")
...
c.content.headers.accept_language = "en-UG,en;q=0.8,fi;q=0.6"
...
c.url.start_pages = "http://localhost/MainPage/"
